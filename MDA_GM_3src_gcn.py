...
l2_decay = 5e-4
class_num = 65
# root_path = "D:/dataset/OfficeHome/"
# source1_name = "Art"
...
source2_loader = torch.utils.data.DataLoader(data_loader.Office(s_2_list_path),
                                             batch_size=batch_size, shuffle=True, drop_last=True, num_workers=0)
source3_loader = torch.utils.data.DataLoader(data_loader.Office(s_3_list_path),
                                             batch_size=batch_size, shuffle=True, drop_last=True, num_workers=0)
...
if __name__ == '__main__':
    ...
    log_dir = 'loggcn' + '/' + target_name + '/' + source1_name + '-' + source2_name + '-' + source3_name + '-' + str(lr)+tag
