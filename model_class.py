        ...
        if self.training == True:
            ...
            if mark == 1:
                ...
                for c in range(self.classes):
                    ...
                    intra_loss += mmd.mmd(ps * data_src, pt * data_tgt_son1)
                ...
                intert_loss += mmd.mmd(pt1 * data_tgt_son1, pt2 * data_tgt_son1)
            ...
            if mark == 2:
                ...
                for c in range(self.classes):
                    ps = s_label[:, c].reshape(data_src.shape[0], 1)
                    pt = t_label[:, c].reshape(data_src.shape[0], 1)
                    intra_loss += mmd.mmd(ps * data_src, pt * data_tgt_son2)
                ...
                pt1 = t_label[:, tmax].reshape(data_src.shape[0], 1)
                pt2 = t_label[:, tmax2].reshape(data_src.shape[0], 1)
                intert_loss += mmd.mmd(pt1 * data_tgt_son2, pt2 * data_tgt_son2)
            ...
            if mark == 3:
                ...
                for c in range(self.classes):
                    ps = s_label[:, c].reshape(data_src.shape[0], 1)
                    pt = t_label[:, c].reshape(data_src.shape[0], 1)
                    intra_loss += mmd.mmd(ps * data_src, pt * data_tgt_son3)
                ...
                pt1 = t_label[:, tmax].reshape(data_src.shape[0], 1)
                pt2 = t_label[:, tmax2].reshape(data_src.shape[0], 1)
                intert_loss += mmd.mmd(pt1 * data_tgt_son3, pt2 * data_tgt_son3)
